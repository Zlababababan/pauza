...
import { grantAllowance, handleAllowanceAlarm, clearExpiredAllowances } from './allowances.js';
...
chrome.storage.onChanged.addListener((changes, area) => {
  if (area === 'local' && changes.rules) {
    rebuildDnrRules(changes.rules.newValue ?? []).catch((e) => console.error('rebuildDnrRules', e));
  }
});
